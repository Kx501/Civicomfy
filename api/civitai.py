...
class CivitaiAPI:
    ...
    def _request(self, method: str, endpoint: str, params: Optional[Dict] = None,
        ...
        try:
            ...
            return {"error": "Invalid JSON response", "details": response_text,
    ...
    def search_models(self, query: str, types: Optional[List[str]] = None,
                      sort: str = 'Highest Rated', period: str = 'Year',
                      limit: int = 20, page: int = 1,
                      nsfw: Optional[bool] = None, base_models: Optional[List[str]] = None) -> Optional[Dict[str, Any]]:
        ...
        # Add page parameter only for browsing mode (no query) or when page is not None
        # For query searches, use cursor-based pagination
        if not query and page is not None:
        ...
        if types:
            ...
            params["types"] = types
        if base_models:
            # Add base models filter
            params["baseModels"] = base_models
        # Always pass NSFW parameter to API
